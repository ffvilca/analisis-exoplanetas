...
# *Introducción*
  ...
  <p align="justify"> El Universo en el que vivimos es inmensamente grande y la comprensión que tenemos de este es practicamente nula. Sin embargo, gracias al conocimiento científico hemos sido capaces de cada día ir avanzando un poco más en entender como funciona este. Una de las ramas que se esta estudiando es el descubrimiento de exoplanetas, que son aquellos planetas que giran alrededor de otra estrella que no es el Sol de nuestro Sistema Solar, es decir, prácticamente la búsqueda de nuevos mundos a través del Universo.</p>
  
  <p align="justify"> Se deben estar preguntando porque nos interesaría hablar sobre otros mundos que están a miles de millones de kilometros de nosotros,y la respuesta es bastante simple, puesto que, a pesar de la distancia entre estos, conocer otros exoplanetas nos será de gran ayuda para tener una mejor comprensión de nuestro propio Sistema Solar, y por consiguiente, de La Tierra. Además, a lo largo del último tiempo el cambio climático y el calentamiento global ha ido en aumento, haciendo de nuestro hogar cada día que pasa un lugar menos habitable para los seres vivos. Por ello, las grandes potencias mundiales están comenzando a buscar otras opciones para vivir, por lo que aquí la investigación y búsqueda de los exoplanetas se ha vuelto tan importante.</p>
  ...
  <p align="justify"> Este informe se organizará en cuatro secciones, la **primera** de ellas será la que nos de un contexto sobre qué son los exoplanetas, se explicará desde cuando se buscan y la importancia que tienen. La **segunda sección** será la que explique la metodología que se usará para hacer el analisis del dataset, para poder extraer la mayor información posible. A continuación, en la **tercera** presentarán los resultados mediante gráficos que resuman la información. Finalmente, en la **cuarta** y última sección, se entregan las conclusiones sobre por qué es bueno seguir buscando exoplanetas y por qué sería bueno poder llegar a ellos.</p>
...
<p align="justify"> Más de alguna vez te debiste haber preguntado que pasaría si tuviera más días en el año, quizas podría dormir más, podría viajar más o comenzar a aprender algo nuevo. Quizás en otro planeta el año terrestre podría durar 10 años, dado la velocidad que se mueve el planeta alrededor de su estrella, y quizás es mucho tiempo. Por lo anterior , el criterio de cuanto dura un périodo orbital es un dato que necesitamos tener, ya que, con ello también nos podemos ajustar a las estaciones del año que tendría este nuevo planeta. </p>

</p align="justify">Por lo mencionado anteriormente, para el analisis de esta variable elegiremos a aquellos exoplanetas cuyo periodo orbital se encuentra entre los 360 y 400 días.</p>
...
# *¿Qué nos dicen los datos?*
  ...
  <p align="justify"> Una vez que logramos entender cuales son aqueelas variables que vamos a utilizar para hacer el analisis sobre los candidatos a futuro hogar para la humanidad, ahora pasaremos a mostrar en forma de gráfico cada una de estas tématicas:</p>
